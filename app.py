...
# Load data
df = pd.read_csv('/Users/burgefamily/CPSC325/dspl-pga-tour-project/streamlit_hw/data/ASA All PGA Raw Data - Tourn Level.csv')

# Load the machine learning model
# with open('/Users/burgefamily/CPSC325/dspl-pga-tour-project/model.pkl', 'rb') as f:
#     model = pickle.load(f)

tournament_field_df = pd.read_csv('/Users/burgefamily/CPSC325/dspl-pga-tour-project/streamlit_hw/data/2024_masters.csv')
